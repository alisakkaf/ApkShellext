...
namespace ApkShellext.ApkChunk
{
    /// <summary>
    /// From R.java
    /// </summary>
    ...
    {
        [Serializable]
        protected struct ApkChunkHeader
        {
        ...
        public static ApkChunk ReadChunkFile(ref byte[] bytes) {
            ...
            switch (chunktype) {
                ...
                case RES_TYPE.RES_TABLE_TYPE:
                    return new ApkTableChunk(bytes);
                default:
    ...
    [Serializable]
    public class ApkStringPoolChunk : ApkChunk
    {
        ...
        public virtual string OutputXML() {
            ...
            foreach (ApkChunk chunk in chunks) {
                if (chunk.type == RES_TYPE.RES_STRING_POOL_TYPE ||
                    ...
                    xml += ((ApkXMLChunk)chunk).OutputXML();
            }
            return xml;
        }
    ...
    public class ApkXMLElementChunk : ApkXMLChunk
    {
        ...
        public override string OutputXML() {
            ...
            using (BinaryReader br = new BinaryReader(ms)) {
                ...
                if (ns != "") name = ns + ":" + name;
                UInt16 attrstart = br.ReadUInt16();
                UInt16 attrsize = br.ReadUInt16();
                UInt16 attrcount = br.ReadUInt16();
                id = br.ReadUInt16();
                @class = br.ReadUInt16();
                style = br.ReadUInt16();
