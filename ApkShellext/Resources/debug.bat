...
CLS
ECHO ===================================================================
ECHO   AliSakkaF ApkShellext - Debugging & Diagnostics Mode
ECHO ===================================================================
ECHO.
...
ECHO -------------------------------------------------------------------
ECHO   Registering Shell Extension (Bypassing locks)...
ECHO -------------------------------------------------------------------
...
echo   [STATUS] Windows Explorer successfully restarted.
echo.

ECHO ===================================================================
ECHO   Debugging Configuration Loaded!
ECHO.
ECHO   * GitHub:   https://github.com/alisakkaf
ECHO   * Facebook: https://www.facebook.com/AliSakkaf.Dev/
ECHO   * Website:  https://alisakkaf.com/
